...
void addcontacts() {
      ...
      contact newcontact;
      newcontact.name = (char*)malloc(MAX_NAME_LENGTH * sizeof(char));
      newcontact.number = (char*)malloc(MAX_PHONE_LENGTH * sizeof(char));
...
void deletecontact() {
      ...
      free(contacts[contactindex].name);
      free(contacts[contactindex].number);
